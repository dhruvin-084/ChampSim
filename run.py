...
def tage(lenGlobal = 14, lenTag = 11, maxHistory = 131):
    predictor_name = "tage"
    prefix = "_"+str(lenGlobal)+"_"+str(lenGlobal)+"_"+str(maxHistory)
    bin_name = "bin/champsim_"+predictor_name+prefix
...
run("bin/champsim_perceptron_38_6_268", "_perceptron_8KB", 1000000000, 500000000)
#run("bin/champsim_perceptron_60_10_422", "_perceptron_32KB", 1000000000, 500000000)
